...
public class MaterialCalendarView extends ViewGroup {
    ...
    private static IgetRectListener mIgetRectListener;

    public void setRectListener(IgetRectListener igetRectListener) {
        mIgetRectListener = igetRectListener;
    }
    ...
    public static Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.i(TAG, "" + bottom + left + right + top);

            if (mIgetRectListener != null) {
                mIgetRectListener.getRectBound(bottom, left, right, top);
            }
...
//        topbar.addView(buttonPast, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1));
        ...
        topbar.addView(buttonPast, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 0));
...
//        topbar.addView(buttonFuture, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1));
        ...
        topbar.addView(buttonFuture, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 0));
