...
import com.prolificinteractive.materialcalendarview.interfac.IObserver;
import com.prolificinteractive.materialcalendarview.interfac.ISubject;

import java.util.ArrayList;
import java.util.List;

import static com.prolificinteractive.materialcalendarview.MaterialCalendarView.handler;
...
class DayView extends CheckedTextView implements ISubject {
    ...
    ArrayList<IObserver> mObservers = new ArrayList<>();

    public DayView(Context context, CalendarDay day) {
        super(context);

        fadeTime = getResources().getInteger(android.R.integer.config_longAnimTime);
...
//        setSelectionColor(this.selectionColor);
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        bundle.putInt("bottom", tempRect.bottom);
        bundle.putInt("left", tempRect.left);
        bundle.putInt("right", tempRect.right);
        bundle.putInt("top", tempRect.top);
    ...
    private void regenerateBackground() {
        if (selectionDrawable != null) {
            ...
            setTextColor(createColorStateList(Color.rgb(28, 134, 238), Color.rgb(28, 134, 238), Color.GREEN, Color.WHITE));
...
//        API 22. Technically harmless to leave on for API 21 and 23, but not worth risking for 23+
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.e("----DayView---", "left: ---->" + left + "----top:---->" + top + "----right----->" + right + "----- bottom ----->" + bottom);
