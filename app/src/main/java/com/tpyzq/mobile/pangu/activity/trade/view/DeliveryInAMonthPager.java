 ...
 * 交割单  一月内 标签
 */
public class DeliveryInAMonthPager extends BaseSearchPager {
    private final String TAG = "DeliveryInAMonthPager";
    ...
    public DeliveryInAMonthPager(Context context) {
        super(context);
    }
                    ...
                    if ("0".equals(jsonObject.getString("code"))) {
                        ...
                        if (data != null && data.length() > 0) {
                            ...
                            for (int i = 0; i < data.length(); i++) {
                                ...
                                _bean.setBalance(data.getJSONObject(i).getString("OCCUR_BALANCE"));  //BUSINESS_BALANCE
