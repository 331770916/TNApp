...
/**
 * 作者：刘泽鹏 on 2016/9/18 10:58
 * 电信模块
 */
public class TelecomPager extends BaseInfoPager {


    public static final String TAG = "TelecomPager";
    private PullToRefreshListView mListView;
    private ArrayList<InformationBean> list;
    private ZxTabAdapter adapter;
    private int mIndex = 0;                         //分页加载数据  的  标记
    private ProgressBar pb_Pager;                   //菊花
    private RelativeLayout rl_Pager;                //包裹整个布局的  RelativeLayout
    private LinearLayout llChongXinJiaZai;         //内容为空的   图片

    public TelecomPager(Context context) {
        super(context);
    }
...
//                    }.execute();
    ...
    public void setView() {
        ...
        pb_Pager = (ProgressBar) rootView.findViewById(R.id.pb_Pager);      //显示菊花
        rl_Pager = (RelativeLayout) rootView.findViewById(R.id.rl_Pager);   //初始化背景 默认 为 灰色
