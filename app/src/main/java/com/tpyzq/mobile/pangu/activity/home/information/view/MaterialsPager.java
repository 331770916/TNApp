...
/**
 * 作者：刘泽鹏 on 2016/9/18 11:09
 * 原材料模块
 */
public class MaterialsPager extends BaseInfoPager {

    public static final String TAG = "InformationPager";
    ...
    public MaterialsPager(Context context) {
        super(context);
    }
