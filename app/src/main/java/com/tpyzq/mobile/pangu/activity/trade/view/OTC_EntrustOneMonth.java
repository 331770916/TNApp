...
/**
 * 作者：刘泽鹏 on 2016/9/6 21:20
 */
public class OTC_EntrustOneMonth extends BasePager  {

    private String TAG = "OTC_EntrustOneMonth";
    private PullToRefreshListView mListView;
    private ArrayList<HashMap<String,String>> list;
    private OTC_EntrustTodayAdapter adapter;
    private ImageView OTCEntrustKong;

    public OTC_EntrustOneMonth(Context context) {
        super(context);
    }
