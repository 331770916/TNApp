 ...
 * 三月
 */
public class CurrencyThreeMonthPager extends BasePager implements RefreshListView.OnRefreshListener {
    ...
    public CurrencyThreeMonthPager(Context context) {
        super(context);
    }
