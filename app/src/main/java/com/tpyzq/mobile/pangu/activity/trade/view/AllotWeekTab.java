 ...
 * 一周内
 */
public class AllotWeekTab extends BaseTab implements PullLayout.OnPullCallBackListener{

    public AllotWeekTab(Activity activity, ArrayList<BaseTab> tabs) {
        super(activity, tabs);
    }

    private AllotQueryItemAdapter mAdapter;
    private static final String TAG = "WeekTab";
    ...
    private void getWeekConnect(String pageNum, String beginDate, String endDate) {
