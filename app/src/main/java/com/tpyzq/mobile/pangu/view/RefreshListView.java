...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.refush_listview_footer, null);
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.refush_listview_head, null);
        ivArrow = (ImageView) headerView.findViewById(R.id.arrow_iv);
        mProgressBar = (ProgressBar) headerView.findViewById(R.id.head_progress);
        tvState = (TextView) headerView.findViewById(R.id.tip);
        tvLastUpdateTime = (TextView) headerView.findViewById(R.id.head_title);
