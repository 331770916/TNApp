...
/**
 * 作者：刘泽鹏 on 2016/9/18 11:00
 * 工业模块
 */
public class IndustryPager extends BaseInfoPager {


    public static final String TAG = "IndustryPager";
    ...
    public IndustryPager(Context context) {
        super(context);
    }
