...
/**
 * 作者：刘泽鹏 on 2016/9/18 10:59
 * 医疗模块
 */
public class MedicalPager extends BaseInfoPager {


    public static final String TAG = "MedicalPager";
    ...
    public MedicalPager(Context context) {
        super(context);
    }
