...
public class CertificationDialog {
    ...
    public static Dialog showDialog(String titles,String msg, String but, String but1, Activity activity, final PositiveCliceListener positiveCliceListener, final CancleClickListener cancleClickListener) {
