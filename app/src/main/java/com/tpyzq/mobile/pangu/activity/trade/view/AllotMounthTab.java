 ...
 * 一月内
 */
public class AllotMounthTab extends BaseTab implements PullLayout.OnPullCallBackListener{

    public AllotMounthTab(Activity activity, ArrayList<BaseTab> tabs) {
        super(activity, tabs);
    }

    private AllotQueryItemAdapter mAdapter;
    private static final String TAG = "MounthTab";
    ...
    private void getMounthConnect(String pageNum, String beginDate, String endDate) {
