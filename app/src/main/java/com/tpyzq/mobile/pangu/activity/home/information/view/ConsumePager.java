...
/**
 * 作者：刘泽鹏 on 2016/9/18 11:07
 * 消费模块
 */
public class ConsumePager extends BaseInfoPager {

    public static final String TAG = "ConsumePager";
    ...
    public ConsumePager(Context context) {
        super(context);
    }
