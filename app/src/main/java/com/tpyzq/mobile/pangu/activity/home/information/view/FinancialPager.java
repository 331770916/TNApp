...
/**
 * 作者：刘泽鹏 on 2016/9/18 09:48
 * 金融业模块 首页
 */
public class FinancialPager extends BaseInfoPager {
    public static final String TAG = "FinancialPager";
    ...
    public FinancialPager(Context context) {
        super(context);
    }
