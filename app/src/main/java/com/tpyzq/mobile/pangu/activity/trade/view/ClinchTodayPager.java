 ...
 * 成交 查询 今日   标签
 */
public class ClinchTodayPager extends BaseSearchPager {
    private String TAG = "ClinchTodayPager";
    ...
    public ClinchTodayPager(Context context) {
        super(context);
    }
                    ...
                    if ("0".equals(jsonObject.getString("code"))) {
                        ...
                        if (data != null && data.length() > 0) {
                            ...
                            for (int i = 0; i < data.length(); i++) {
                                ...
                                _bean.setDate(data.getJSONObject(i).getString("TRD_DATE"));//日期
