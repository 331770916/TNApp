 ...
 * 货币基金Mark
 */
public class MyFundMarkView extends MarkerView {
    ...
    public MyFundMarkView(Context context, int layoutResource) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        tvContent.setText("七日年化收益率:" +  mFormat.format(e.getVal()) + "\n时间：" + date);
    }
