...
/**
 * 作者：刘泽鹏 on 2016/9/18 11:06
 * 公共事业模块
 */
public class PublicUtilitiesPager extends BaseInfoPager {


    public static final String TAG = "PublicUtilitiesPager";
    ...
    public PublicUtilitiesPager(Context context) {
        super(context);
    }
