...
/**
 * 作者：刘泽鹏 on 2016/8/31 16:54
 */
public class OTC_RedeemChiCangAdapter extends BaseAdapter{

    private Context context;
    private ArrayList<OTC_RedeemEntity> list;
    private int point=-1;

    public OTC_RedeemChiCangAdapter(Context context) {
    ...
    public void setList(ArrayList<OTC_RedeemEntity> list){
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.productName.setText(intentBean.getStockName());
        ...
        if(position == point){
            ...
            viewHolder.ivDuiGou.setVisibility(View.INVISIBLE);
        }
