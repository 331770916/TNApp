...
public class StockCapital extends BaseStockDetailPager {
    ...
    private void getCaptial(String stockcode) {
        ...
        NetWorkUtil.getInstence().okHttpForPostString("", ConstantUtil.URL_NEW, map100207, new StringCallback() {
            @Override
        ...
        NetWorkUtil.getInstence().okHttpForPostString("", ConstantUtil.URL_NEW, map100208, new StringCallback() {
            @Override
            public void onError(Call call, Exception e, int id) {
                ToastUtils.showShort(mContext, "网络访问失败");
            }
