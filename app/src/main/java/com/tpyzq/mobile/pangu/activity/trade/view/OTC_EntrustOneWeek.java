...
/**
 * 作者：刘泽鹏 on 2016/9/6 21:08
 * OTC 委托查询 一周
 */
public class OTC_EntrustOneWeek extends BasePager  {

    private String TAG = "OTC_EntrustOneWeek";
    private PullToRefreshListView mListView;
    private ArrayList<HashMap<String,String>> list;
    private OTC_EntrustTodayAdapter adapter;
    private ImageView OTCEntrustKong;

    public OTC_EntrustOneWeek(Context context) {
        super(context);
    }
